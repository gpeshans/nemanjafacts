...
namespace APINS
{
    ...
    /// <summary>
    /// Summary description for TwitterAPI
    /// </summary>
    public class API
    {
                                ...
                                Dictionary<string, string> args)
        {
            ...
            Uri baseURL = new Uri(siteBaseUrl);
            ...
            {
                throw new APIException("error", obj.Dictionary["error"].String);
            }
            return obj;
        }
                                   ...
                                   Dictionary<string, string> args)
        {
            ...
            {
                throw new APIException("Server Error", e.Message);
            }
        }
        ...
        public string EncodeDictionary(Dictionary<string, string> dict,
                                        bool questionMark)
        {
